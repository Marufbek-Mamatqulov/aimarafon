...
const navItems = [
  ...
  { href: "/admin/participants", label: "Ishtirokchilar", icon: Users },
  { href: "/admin/tasks", label: "Topshiriqlar", icon: ClipboardList },
  { href: "/admin/submissions", label: "Yuborilganlar", icon: FileSpreadsheet },
  { href: "/admin/evaluations", label: "Baholash", icon: BarChart3 },
      ...
      <div className="mx-auto flex w-full max-w-7xl gap-6 px-4 py-6 sm:px-6 lg:px-8">
        <aside className="hidden w-64 flex-col gap-4 rounded-3xl border border-slate-200/70 bg-white p-4 shadow-sm lg:flex">
          <div>
            ...
            <p className="mt-2 text-lg font-semibold text-slate-900">Boshqaruv paneli</p>
          </div>
        ...
        <div className="flex-1 space-y-6">
          <header className="flex flex-wrap items-center justify-between gap-4 rounded-3xl border border-slate-200/70 bg-white px-6 py-4 shadow-sm">
            <div>
              ...
              <p className="text-lg font-semibold text-slate-900">Nazorat va monitoring</p>
            </div>
